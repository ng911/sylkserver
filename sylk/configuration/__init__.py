...
from sylk.configuration.datatypes import AudioCodecs, VideoCodecs, IPAddress, Path, Port, PortRange, SIPProxyAddress, SRTPEncryption, LogLevel
...
class RTPConfig(ConfigSection):
    ...
    video_codecs = ConfigSetting(type=VideoCodecs, value=['H264'])
